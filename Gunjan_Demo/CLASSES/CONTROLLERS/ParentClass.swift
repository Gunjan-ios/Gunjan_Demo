...
//        }
    ...
    func showBanner(title :String , subTitle : String , style : BannerStyle ,vc : ViewController) {
        ...
        banner1.show(queuePosition: .front, bannerPosition: .top, queue: .default, on: vc , cornerRadius: 10.0)
    }
